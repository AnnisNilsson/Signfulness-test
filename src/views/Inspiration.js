    ...
    <Grid container spacing={10} className={classes.container}>
      ...
      <Grid item xs={10} className={classes.boxContainer}>
        <InspirationBox1
          ...
          text=' Självkärlek handlar om att komma i kontakt med dig själv och även en djup kärlek till dig själv, välmående och lycka. Men vad betyder det egentligen? Jo, du kanske tänker att detta endast omfattar kärlek till din kropp men det är mycket mer än så. Själv kärlekshandling är att verkligen älska dig själv, på ett djupare sätt. Att du accepterar den du är, din kropp och dina misstag. Det kan tyckas som en tuff utmaning och det är det men samtidigt är det väldigt viktigt för ditt välmående.
...
Var din egen bästa vän, nu och för alltid. '
      ...
      <Grid item xs={10}>
        <InspirationBox4
          ...
          text='Andning är livsviktigt. I samhället stressar vi så mycket och är uppe i varv att vi glömmer bort att andas ordentligt. Vi andas för lite och ytligt, från andningen grundare och flyttas upp i bröstet. Genom att andas långt ner i magen aktiveras kroppens broms vilket leder till minskat stresspåslag sänkt blodtrycket. Vid stress andas du snabbare än vad du bör, vilket kan leda till trötthet, sämre immunförsvar och en långsammare förbränning.
